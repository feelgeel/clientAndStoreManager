...
import {  listReducer, 
        ...
        SET_GTINGS_BY_CATEG,SET_MODES,ADD_PURCHASE } from './reducers';
...
const ListState = props => {
  ...
  useReducer(listReducer, { 
    ...
    User:{},Token:"",TheProd:[],TheGting:[],TheCateg:{},CategStore:[],
    GtingsByCateg:[],Mode:"",Purchase:[] });
  ...
  //////////////////////
    ///////the mode/////
    //////////////////////////
    const setModes = product => {
        setTimeout(() => {
          // setCart(updatedCart);
          dispatch({ type: SET_MODES, product: product });
        });
      };
  ...
  //////////////////////
    ///////the GTING/////
    //////////////////////////
    const setTheGting = TheChosen => {
        setTimeout(() => {
          // setCart(updatedCart);
          dispatch({ type: SET_THEGTING, product: TheChosen });
        });
      };
...
//////////////////////
 ...
 //////////////////////
  ///////Purchases funct/////
  //////////////////////////
    const addToPusrchases = product => {
      setTimeout(() => {
        // setCart(updatedCart);
        dispatch({ type: ADD_PURCHASE, product: product });
      });
    };
//////////////////////
  ///////listName funct/////
  ...
  return (
    <ListContext.Provider
      value={{
        ...
        Purchase:listState.Purchase,
        addToPusrchases: addToPusrchases,
