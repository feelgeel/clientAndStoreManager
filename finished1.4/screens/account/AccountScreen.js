...
import { fatherAccount, motherAccount, sonAccount, daughterAccount, storeOwnerAccount, storeWorkerAccount, supplierAccount, supplierWorkerAccount, manifactureAccount, manifactureWorkerAccount } from "./accountFunc";
  ...
  const handleAccountChange=async(account)=>{
    ...
    fatherAccount(father,user,dispatch,
      setfamilyLoginModal,setchangeAccountModal,account)
        break;
    case "mother":
    motherAccount(mother,user,dispatch,setchangeAccountModal,
      setmotherModal,account)
        break;
     case "son":
     sonAccount(son,setchangeAccountModal,user,dispatch,
      setsonModal,account)
    //  setsonModal(true)
    break;
     case "daughter":
     daughterAccount(daughter,user,dispatch,setdaughterModal,
      setchangeAccountModal,account)
    break;
     case "storeOwner":
     storeOwnerAccount(owner,user,dispatch,setchangeAccountModal,
      setstoreOwnerModal,account)
    break;
    
    case "storeworker":
    storeWorkerAccount(st_worker,user,dispatch,setchangeAccountModal,
      setstoreWorker,account)
    break;
    case "supplier":
    supplierAccount(supplierDt,user,dispatch,setchangeAccountModal,
      setsupplier,account)
    break;
    case "supplierWorker":
    supplierWorkerAccount(supplierWorker,user,dispatch,setchangeAccountModal,
      setsupplierWorkerModal,account)
    break;
    case "manifacture":
    manifactureAccount(manifactureDt,user,dispatch,setchangeAccountModal,
      setmanifactureModal,account)
    break;
    case "manifactureWorker":
    manifactureWorkerAccount(manifactureWorker,user,dispatch,
