...
//   console.log("st_man_list",st_manual_order_list._id)
     chosen.map(async(chosenDt)=>{
      ...
      const {data:clientProd}=await clientAddProduct(newchosen)
      let new_clientProd={...clientProd};
      // new_clientProd.image_front_url=chosenDt.image_front_url
      // new_clientProd.brands=chosenDt.brands
      dispatch(ClientListAction.pushProducts(new_clientProd));
