...
import { handleAddStoreWorkerMember } from './AddStoreWorkerFunc';
...
function AddStoreWorker({children,style}) {
...
<C_Button
        title="add store memeber"
        // color={buttonColor}
        onPress={()=>setaddFamModal(true)} />
<C_Button
        title="remove store member"
        // color={buttonColor}
