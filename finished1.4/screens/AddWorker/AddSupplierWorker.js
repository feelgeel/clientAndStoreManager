...
import { handleAddSupplierWorkerMember } from './AddSupplierWorkerFunc';
...
function AddSupplierWorker({children,style}) {
...
<C_Button
        title="add supplier memeber"
        // color={buttonColor}
        onPress={()=>setaddSupplierWorkerModal(true)} />
<C_Button
        title="remove supplier member"
        // color={buttonColor}
...
<C_Form
    ...
    onSubmit={(values)=>{
        // console.log(values)
        handleAddSupplierWorkerMember(values,family,setaddSupplierWorkerModal)
...
export default AddSupplierWorker;