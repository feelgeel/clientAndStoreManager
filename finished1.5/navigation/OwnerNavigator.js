...
import ListorderingScreen from "../screens/listOrder/ListOrderScreen/";
...
import WorkerManagerScreen from "../screens/worker/WorkerManagerScreen";
...
const FeedNavigator = () => (
  <Stack.Navigator mode="modal" screenOptions={{ headerShown: false }}>
     ...
     <Stack.Screen name="showlists" component={WorkerManagerScreen} /> 
     <Stack.Screen name="workerManager" component={WorkerManagerScreen} /> 
    ...
    <Stack.Screen name="storeModeScreen" component={StoreModeScreens} />
