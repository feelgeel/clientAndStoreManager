...
import { FlatList, StyleSheet,View, Button, ActivityIndicator,Modal } from "react-native";
...
// console.log(TheListName.chosenIds);
  ...
  // }else{
    // const purchases=context.Purchase
    let filteredPurchase=purchases.filter(
      t=>t.listName==TheListName.listName)
    console.log("thechosenprod",filteredPurchase);
    ...
    <Screen style={styles.screen}>
      ...
      <View style={{height:150,paddingLeft:"5%",paddingTop:"10%"}}>
        <C_Text style={{color:"white"}}>HELLO CISCO</C_Text>
        <C_Text style={{color:"white"}}>Have a nice day</C_Text>
      </View>
         <ListItem
          title="ADD AN ITEM"
      ...
      <View style={{height:"2%"}}>
        ...
        {<FlatList
          ...
          keyExtractor={(filteredPurchase) => filteredPurchase._id.toString()}
         ...
         <Modal visible={visible} onDismiss={hideModal} contentContainerStyle={containerStyle}>
          <View >
            <C_Text >are you sure u want to delete</C_Text>
