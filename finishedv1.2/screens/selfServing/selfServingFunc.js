...
export const handleAddToChosen=(theChosen,
    ...
    product,setproduct,
    chosen,setchosen,user,price,stockAlert,values)=>{
...
let newProd={...scannedgtingResProd}
let newChosen=[...chosen]
...
setproduct([])
 ...
 export const handleScannedGting=async(scannedGting,setscannedProd,
  setscannedProdModel,user,settheChosen,chosen,dispatch,setscannedgtingResProd
  ,setscannedgtingResChosen)=>{
